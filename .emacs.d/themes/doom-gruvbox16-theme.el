...
;;
(def-doom-theme doom-gruvbox16
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256           16
  (
   (bg         '("#282828" "black"         nil))
   (bg-alt     '("#3c3836" "#3c3836"       nil))
   ...
   (fg         '("#ebdbb2" "brightwhite"   "brightwhite"))
   (fg-alt     '("#d5c4a1" "#d5c4a1"       "brightwhite"))
   (grey       '("#a89984" "#a89984"       "brightblack"))
   (red        '("#fb4934" "red"           "red"))
   (magenta    '("#fb2874" "magenta"       "magenta"))
   (violet     '("#d3869b" "brightmagenta" "brightmagenta"))
   (orange     '("#d65d0e" "#d65d0e"       "brightred"))
   ...
   (cyan       '("#83a598" "brightcyan"    "brightcyan"))
   (dark-cyan  '("#458588" "cyan"          "cyan"))

...
theme.titlebar_ontop_button_focus_active  = theme_path .. "ontop_focus_active.png"
theme.titlebar_ontop_button_normal_active = theme_path .. "ontop_normal_active.png"
theme.titlebar_ontop_button_focus_inactive  = theme_path .. "ontop_focus_inactive.png"
theme.titlebar_ontop_button_normal_inactive = theme_path .. "ontop_normal_inactive.png"

theme.titlebar_sticky_button_focus_active  = theme_path .. "sticky_focus_active.png"
theme.titlebar_sticky_button_normal_active = theme_path .. "sticky_normal_active.png"
theme.titlebar_sticky_button_focus_inactive  = theme_path .. "sticky_focus_inactive.png"
theme.titlebar_sticky_button_normal_inactive = theme_path .. "sticky_normal_inactive.png"

theme.titlebar_floating_button_focus_active  = theme_path .. "floating_focus_active.png"
theme.titlebar_floating_button_normal_active = theme_path .. "floating_normal_active.png"
theme.titlebar_floating_button_focus_inactive  = theme_path .. "floating_focus_inactive.png"
theme.titlebar_floating_button_normal_inactive = theme_path .. "floating_normal_inactive.png"
